...
class ChiasmaDepositValidationDeployer:
    def __init__(self, chiasma_deposit, file_deployer, path_actions):
        ...
        self.shortcut_examiner = ShortcutExaminer(
            self.chiasma_deposit.branch_provider, self.os_service, self.chiasma_deposit.windows_commands,
            file_deployer, self.chiasma_deposit.path_properties.shortcut_path)
    ...
    def copy_validation_files(self):
        ...
        if self.os_service.exists(self.chiasma_deposit.path_properties.archive_dir_validation_files):
